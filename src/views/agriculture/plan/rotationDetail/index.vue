<template>
  <div class="page-content">
    ...
    >
      ...
      <template #bottom>
        <el-button @click="handleAdd" v-hasPermi="['agriculture:plandetail:add']" v-ripple>新增</el-button>
        <el-button @click="handleExport" v-hasPermi="['agriculture:plandetail:export']" v-ripple>导出</el-button>
      </template>
    </table-bar>
